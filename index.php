    ...
    <div id="video">
        ...
        <header id="header">
            ...
            <div class="container-fluid">
                <div class="navbar">
                    <a href="http://localhost:8080/maps_interaktif/index.php" id="logo" title="Peta Interaktif">
                        Peta Interaktif
                    </a>
                        ...
                        <nav id="navigation">
                            ...
                            <div class="nav-box navbar-collapse">
                                <ul class="navigation-menu nav navbar-nav navbars" id="nav">
                                    ...
                                    <li data-menuanchor="slide06"><a href="#slide06">Testi</a></li>
        ...
        <!--<video autoplay muted loop id="myVideo">
          <source src="images/aircrew" type="video/jpg">
        </video> -->
		<!--<video autoplay muted loop id="myVideo">
          <source src="images/video-bg.mp4" type="video/mp4">
        </video> -->
		<style>
		body { background-image: url('images/bg581.jpg')
		}
		</style>
